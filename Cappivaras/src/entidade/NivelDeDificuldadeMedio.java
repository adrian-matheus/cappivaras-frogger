...
public class NivelDeDificuldadeMedio extends NivelDeDificuldade {

    public NivelDeDificuldadeMedio( PainelDeJogo painelDeJogo ) {
		
		this.painelDeJogo = painelDeJogo;
		NivelDeDificuldade.mapaDeEntidades = "/mapaDeEntidades_Medio.txt";
	}		
